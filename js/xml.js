...
for (let j = 0; j < jugadores.length; j++) {
        ...
        jugadorItem.textContent = jugador.getAttribute('nombre') + ' - Posición: ' + jugador.getAttribute('posicion') + ', Número: ' + jugador.getAttribute('numero') + jugador.getAttribute('apodo');
